...
void InfraredAppSceneUniversalOrbFan::on_enter(InfraredApp* app) {
    InfraredAppViewManager* view_manager = app->get_view_manager();
    ButtonPanel* button_panel = view_manager->get_button_panel();
    button_panel_reserve(button_panel, 2, 3);
    ...
    button_panel_add_item(
        ...
        infrared_app_item_callback,
        app);
    brute_force.add_record(i, "SPEED+");
    ++i;
    button_panel_add_item(
        button_panel,
        i,
        ...
        infrared_app_item_callback,
        app);
    brute_force.add_record(i, "ROTATE+");
    ++i;
    button_panel_add_item(
        button_panel,
        i,
    ...
    button_panel_add_label(button_panel, 6, 11, FontPrimary, "Orb Fan");
    button_panel_add_label(button_panel, 9, 64, FontSecondary, "Spd");
    button_panel_add_label(button_panel, 43, 64, FontSecondary, "Rot");
